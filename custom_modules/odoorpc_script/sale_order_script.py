...
odoo.login("script_db_1", "admin", "admin")

start_time = datetime.now()

with open(
    "/home/odoo/komal_odoo/odoo-14/custom_modules/odoorpc_script/sale_order.csv",
    newline="",
) as csv_file:
...
with open(
    "/home/odoo/komal_odoo/odoo-14/custom_modules/odoorpc_script/sale_order_line.csv",
    newline="",
) as csv_file:
    csv_file = csv.DictReader(csv_file)
    excel_row_line = 2
